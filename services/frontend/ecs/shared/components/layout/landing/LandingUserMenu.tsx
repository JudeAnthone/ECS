...
export function LandingUserMenu({
	...
	return (
		<div className="w-full flex items-center gap-4 bg-[#BA0021] px-4 py-2">
					...
					>
						<div className="flex items-center gap-3 px-4 py-3 text-left text-sm bg-[#BA0021]/5 rounded-t-xl relative">
							...
							<div className="grid flex-1 text-left text-sm leading-tight">
								<span className="truncate font-semibold text-[#BA0021]">
									{user.name}
								</span>
			...
			{notifOpen && (
				<div
					className="absolute z-50 mt-2 left-0 min-w-[300px] max-w-[90vw] rounded-xl shadow-2xl border border-slate-200 bg-white animate-fade-in"
					style={{ top: "60px" }}
				>
