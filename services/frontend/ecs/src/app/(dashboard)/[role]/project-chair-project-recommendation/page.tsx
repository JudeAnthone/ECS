      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {showSuccess && (
          <Alert className="border-green-300 bg-green-50">
            ...
            <AlertTitle className="text-green-900 font-semibold">Recommendation Submitted Successfully!</AlertTitle>
            <AlertDescription className="text-green-700">
              Your project recommendation has been submitted and will be reviewed by the management team. You will receive feedback within 5-7 business days.
            </AlertDescription>
          </Alert>
        )}
