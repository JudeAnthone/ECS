      ...
      <div className="max-w-[1920px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600 text-lg">View, print, accepts, and rejection of project requested.</p>
          </div>
        ...
        <Card className="bg-white border-slate-200 shadow-lg">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-slate-900 text-2xl mb-2">Requested Project List</CardTitle>
                <CardDescription className="text-slate-600">
                  Search and filter reports by department or ID
                </CardDescription>
              </div>
            </div>
